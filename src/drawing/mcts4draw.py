...
class MCTS(object):
    """arranged version of MCTS for drawing graph with networkx

        Only difference from original is return item of start method.
        This version return not only act_index but also root node object
        of MCTS tree.
    ...
    def start(self, start_state):
        ...
        Returns:
            v_0: root node object of MCTS tree
